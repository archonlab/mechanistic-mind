...
export function NearFieldSensorPanel({
  ...
  return (
    <div className="panel science-card">
      ...
      <div className="section-label" style={{ marginTop: 8 }}>Authority (readout)</div>
      {visionMech ? (
        <div className="metric">
          <span>Physical near-field vision</span>
          <strong>{visionMech.enabled ? 'ON' : 'OFF'}</strong>
        </div>
      ) : (
      ...
      <div className="metric">
        ...
        <strong>R={radius} · max {maxCand} cells</strong>
      </div>
      <div className="subtle">
        Vision enable / radius / surface / mapping / spatial mode: Experiment → Vision.
